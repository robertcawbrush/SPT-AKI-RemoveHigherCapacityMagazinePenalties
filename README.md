Text copy of description on spt.hub, not the markdown try and read [here](https://hub.sp-tarkov.com/files/file/1621-high-er-capacity-magazine-load-penalty-remover/) first
